...
import { CalendarRange, ChevronDown, LayoutDashboard, LogOut, UserRound } from 'lucide-react';
...
export function AccountDropdown({
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {isOpen ? (
        <div
          className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-64 rounded-[24px] border border-border bg-popover/95 p-2 shadow-[0_24px_60px_-24px_rgba(28,31,42,0.35)] backdrop-blur-xl"
          role="menu"
        >
